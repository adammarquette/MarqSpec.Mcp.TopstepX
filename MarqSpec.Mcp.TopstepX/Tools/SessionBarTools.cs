    ...
    TimeProvider clock)
{
    ...
    [Description(
        ...
        + "bounds when there is one to name, and when the window falls ENTIRELY on non-trading time — a "
        + "weekend, a holiday, the maintenance break — it carries no bounds and says only to widen the "
        + "window. So a window holding ONLY non-trading days is refused rather than reporting them as \"did "
        + "not trade\"; that signal needs a window that also holds at least one whole session. "
