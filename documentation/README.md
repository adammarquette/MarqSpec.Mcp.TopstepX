...
| [`architecture.md`](architecture.md) | 10.8K | You need **how the pieces fit** — the cache-aside path, the projection, the transports. |
...
| [`data-dictionary.md`](data-dictionary.md) | 7.3K | You need the data model — the nine tables, their keys, and why each key is shaped that way. |
