...
| [`data-dictionary.md`](data-dictionary.md) | 11.5K | You need the data model — the eleven tables, their keys, and why each key is shaped that way. |
## Working agreements
...
| [`deployment.md`](deployment.md) | 1.0K | You are operating a deployed environment — cost, what pages you (gh#526), and later rotation / restore / which release is running (gh#519, gh#523). |
