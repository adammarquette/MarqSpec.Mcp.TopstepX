...
| [`architecture.md`](architecture.md) | 8.9K | You need **how the pieces fit** — the cache-aside path, the projection, the transports. |
...
| [`data-dictionary.md`](data-dictionary.md) | 5.1K | You need the data model — the eight tables, their keys, and why each key is shaped that way. |
