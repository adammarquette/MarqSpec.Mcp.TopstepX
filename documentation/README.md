...
| [`architecture.md`](architecture.md) | 18.4K | You need **how the pieces fit** — the cache-aside path, the projection, the transports. |
| [`mcp-tool-catalogue`](mcp-tool-catalog.md) | 17.2K | You are adding, changing or calling a tool. The tool surface is a contract; this is it. |
