...
| [`project-board-workflow.md`](project-board-workflow.md) | 5.3K | You are filing, grooming or moving a card. **The board is project #5; #4 is retired.** The board makes two of the seven transitions by itself; the other five are somebody's deliberate act. |
