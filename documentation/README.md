...
| Document | ~tok | Read it when |
|---|---:|---|
| [`AGENT-MEMORY.md`](AGENT-MEMORY.md) | 8.2K | **Before starting any work.** It grows by design — *append, don't overwrite* — so this is the row that goes stale first. |
| [`project-board-workflow.md`](project-board-workflow.md) | 5.7K | You are filing, grooming or moving a card. **The board is project #5; #4 is retired.** The board makes two of the seven transitions by itself; the other five are somebody's deliberate act. |
