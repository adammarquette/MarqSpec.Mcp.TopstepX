...
| [`deployment.md`](deployment.md) | 3.5K | You are operating a deployed environment — account and region, staging zone waiting on Cloudflare NS swap, OIDC read-back, secret ARNs (gh#519), cost (gh#527), what pages you (gh#526), WAF lockout (gh#528), and later rotation / restore (gh#523). |
