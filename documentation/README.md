...
| [`architecture.md`](architecture.md) | 13.9K | You need **how the pieces fit** — the cache-aside path, the projection, the transports. |
| [`mcp-tool-catalogue`](mcp-tool-catalog.md) | 16.8K | You are adding, changing or calling a tool. The tool surface is a contract; this is it. |
| [`data-dictionary.md`](data-dictionary.md) | 9.1K | You need the data model — the ten tables, their keys, and why each key is shaped that way. |
