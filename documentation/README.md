...
| [`architecture.md`](architecture.md) | 10.1K | You need **how the pieces fit** — the cache-aside path, the projection, the transports. |
| [`mcp-tool-catalogue`](mcp-tool-catalog.md) | 15.2K | You are adding, changing or calling a tool. The tool surface is a contract; this is it. |
| [`data-dictionary.md`](data-dictionary.md) | 5.5K | You need the data model — the eight tables, their keys, and why each key is shaped that way. |
