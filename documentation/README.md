...
| [`mcp-tool-catalogue`](mcp-tool-catalog.md) | 15.4K | You are adding, changing or calling a tool. The tool surface is a contract; this is it. |
| [`data-dictionary.md`](data-dictionary.md) | 6.0K | You need the data model — the eight tables, their keys, and why each key is shaped that way. |
