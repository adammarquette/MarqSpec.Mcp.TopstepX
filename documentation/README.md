...
| [`project-board-workflow.md`](project-board-workflow.md) | 6.2K | You are filing, grooming or moving a card. **The board is project #5; #4 is retired.** The board makes two of the seven transitions by itself; the other five are somebody's deliberate act. |
...
| [`../CONTRIBUTING.md`](../CONTRIBUTING.md) | 4.8K | Branching, claiming, commits, PRs, and the Definition of Done. |
| [`../AGENTS.md`](../AGENTS.md) | 2.4K | Loads automatically. The non-negotiables and the role routing table. |
