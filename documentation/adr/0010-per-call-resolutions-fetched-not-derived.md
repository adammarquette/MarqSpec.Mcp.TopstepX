...
taken — once, for session bars — by [ADR-0022](0022-session-bars-derived-complete-or-absent.md).
...
at all: there is no such bar unit. ADR-0022 therefore builds them from stored base bars behind exactly the
...
- gh#496 — the session-bars epic. [ADR-0022](0022-session-bars-derived-complete-or-absent.md) holds the
