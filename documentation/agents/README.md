...
| [Platform — `platform.md`](platform.md) | 40.7K | **never automatically — open it yourself** |
| [Coordinator — `coordinator.md`](coordinator.md) | 2.6K | **never automatically — open it yourself** |
