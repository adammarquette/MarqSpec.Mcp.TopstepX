...
| [Code Reviewer — `code-reviewer.md`](code-reviewer.md) | 1.4K | **never automatically — open it yourself** |
| [Platform — `platform.md`](platform.md) | 17.7K | **never automatically — open it yourself** |
