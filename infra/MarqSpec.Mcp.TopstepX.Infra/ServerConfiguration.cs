...
/// it is where a backend token would go and AWS auth is SigV4 on the task role, never a header the host
/// would send (gh#537, gh#646, ADR-0019 invariant 4). <c>Mcp__OAuth__Issuer</c> and
